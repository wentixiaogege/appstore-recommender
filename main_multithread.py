...
def main():
    try:
        ...
        #calculate_app_top_10('C10107104',user_download_history.values()) // uncomment for testing only one app
        ...
        for app in app_info.keys():
           t = threading.Thread(target=calculate_app_top_10, args=(app,user_download_history.values(),))
           t.start()
           threads.append(t)
